# Example RS Observation - Triage Priority - DRAFT PH Road Safety Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example RS Observation - Triage Priority**

## Example Observation: Example RS Observation - Triage Priority

Profile: [RS Observation - Triage Priority](StructureDefinition-rs-observation-triage-priority.md)

**status**: Final

**code**: Triage index (assessment scale)
...
**effective**: 2025-10-31 17:00:00+0800
