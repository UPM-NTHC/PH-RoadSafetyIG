...
* oneiss.incident.location 0..1 BackboneElement "Incident Location"
* oneiss.incident.location.street 0..1 string "House No. and Street (MDS150)"
* oneiss.incident.location.barangay 0..1 Identifier "Barangay (MDS151)"
* oneiss.incident.location.city 0..1 Identifier "City/Municipality (MDS152)"
* oneiss.incident.location.province 0..1 Identifier "Province (MDS153)"
* oneiss.incident.location.region 0..1 Identifier "Region (MDS154)"
* oneiss.incident.location.position 0..1 BackboneElement "Geolocation"
* oneiss.incident.location.position.longitude 0..1 decimal "Longitude"
* oneiss.incident.location.position.latitude 0..1 decimal "Latitude"
...
* postcrash.incident.otherRiskFactors 0..* CodeableConcept "Other risk factors at time of incident (MDS230)"
* postcrash.incident.otherRiskFactorsOther 0..1 string "Other risk factors - Others (MDS231)"
* postcrash.incident.safetyAccessories 0..* CodeableConcept "Safety accessories (MDS232)"
* postcrash.incident.safetyAccessoriesOther 0..1 string "Safety - Others (MDS233)"
