...
* ^meta.versionId = "3"
* ^meta.lastUpdated = "2025-10-30T00:34:07.317+00:00"
* ^url = "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-SafetyDevices"
* ^version = "1"
* ^status = #draft
* ^contact.telecom.system = #email
* ^expansion.identifier = "urn:uuid:b08f04a1-0646-42ab-b290-3b011b95f091"
...
* ^expansion.contains[=].display = "Life vest/Lifejacket/Floatation device (for drowning)"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
* ^expansion.contains[=].code = #102384007
* ^expansion.contains[=].display = "Airbag"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
* ^expansion.contains[=].code = #60054005
* ^expansion.contains[=].display = "Seatbelt"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
...
* ^expansion.contains[=].display = "Childseat"
