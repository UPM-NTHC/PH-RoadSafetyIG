ValueSet: SILPH___Sex__VS_
Id: SILPH-SexVS
Title: "SILPH - Sex (VS)"
Description: "SILPH Value Set for Sex"
* ^meta.versionId = "5"
* ^meta.lastUpdated = "2025-10-30T00:34:07.465+00:00"
* ^url = "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-Sex"
* ^version = "1"
* ^status = #draft
* ^contact.telecom.system = #email
* ^expansion.identifier = "urn:uuid:f37455e9-15d2-44ec-bdac-aa59e9a014ff"
...
* ^expansion.parameter[=].valueUri = "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-Sex|1"
