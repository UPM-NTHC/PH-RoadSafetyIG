...
* ^meta.versionId = "9"
* ^meta.lastUpdated = "2025-10-30T00:34:04.226+00:00"
* ^url = "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-InjuryIntent"
* ^version = "0.1.2"
* ^status = #draft
* ^contact.telecom.system = #email
* ^expansion.identifier = "urn:uuid:67b2131d-b9ec-416e-9a5a-2f6109893397"
...
* ^expansion.contains[=].display = "Unintentional/Accidental"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
* ^expansion.contains[=].code = #361269008
* ^expansion.contains[=].display = "Intentional(violence)"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
* ^expansion.contains[=].code = #276853009
* ^expansion.contains[=].display = "Intentional(self-inflicted)"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
* ^expansion.contains[=].code = #269735005
* ^expansion.contains[=].display = "Undetermined"
...
* $SCT#242056005 "Unintentional/Accidental"
* $SCT#361269008 "Intentional(violence)"
* $SCT#276853009 "Intentional(self-inflicted)"
* $SCT#269735005 "Undetermined"
