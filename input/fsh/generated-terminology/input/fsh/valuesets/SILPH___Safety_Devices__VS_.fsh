ValueSet: SILPH___Safety_Devices__VS_
Id: SILPH-SafetyDevicesVS
Title: "SILPH - Safety Devices (VS)"
Description: "SILPH Value Set for Safety Devices"
* ^meta.versionId = "1"
* ^meta.lastUpdated = "2025-10-27T10:04:09.765+00:00"
* ^url = "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-SafetyDevices"
* ^version = "1"
* ^status = #draft
* ^contact.telecom.system = #email
* ^expansion.identifier = "urn:uuid:616bde4b-e75b-4ac2-a6b9-7fef3eafe186"
* ^expansion.timestamp = "2025-10-27T10:04:14+00:00"
* ^expansion.total = 8
...
* ^expansion.parameter[=].valueUri = "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-SafetyDevices|1"
...
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
* ^expansion.contains[=].code = #427850003
* ^expansion.contains[=].display = "Life preserver flotation device"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
* ^expansion.contains[=].code = #102384007
* ^expansion.contains[=].display = "Motor vehicle airbag"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
* ^expansion.contains[=].code = #60054005
* ^expansion.contains[=].display = "Seat belt"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
* ^expansion.contains[=].code = #285695004
* ^expansion.contains[=].display = "Helmet"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].version = "http://snomed.info/sct/900000000000207008/version/20241001"
...
* ^expansion.contains[=].code = #LA9389-3
* ^expansion.contains[=].display = "Child safety seat"
* SNOMED_CT#260413007 "None"
* SNOMED_CT#427850003 "Life vest/Lifejacket/Floatation device (for drowning)"
* SNOMED_CT#102384007 "Airbag"
* SNOMED_CT#60054005 "Seatbelt"
* SNOMED_CT#285695004 "Helmet"
* SNOMED_CT#74964007 "Others"
* SNOMED_CT#261665006 "Unknown"
* LOINC#LA9389-3 "Childseat"