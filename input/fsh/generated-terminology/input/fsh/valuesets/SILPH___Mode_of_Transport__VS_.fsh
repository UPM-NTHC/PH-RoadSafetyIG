...
* ^meta.versionId = "2"
* ^meta.lastUpdated = "2025-10-27T10:08:32.970+00:00"
* ^url = "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-ModeofTransport"
* ^version = "1"
* ^status = #draft
* ^contact.telecom.system = #email
* ^expansion.identifier = "urn:uuid:290d95e4-0fd6-473c-839c-0a3ba7f34a98"
* ^expansion.timestamp = "2025-10-27T10:08:41+00:00"
* ^expansion.total = 4
...
* ^expansion.contains[=].display = "Walk-in following nonambulance, law enforcement transport"
* ^expansion.contains[+].system = "http://loinc.org"
* ^expansion.contains[=].version = "2.78"
