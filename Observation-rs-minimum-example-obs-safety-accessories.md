# Minimum Data Set Safety Accessories - DRAFT PH Road Safety Implementation Guide v0.3.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Minimum Data Set Safety Accessories**

## Example Observation: Minimum Data Set Safety Accessories

Profile: [RS Observation - Safety Accessories](StructureDefinition-rs-observation-safety-accessories.md)

**status**: Final

**code**: Safety precautions (procedure)
