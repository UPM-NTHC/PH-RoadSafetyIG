# RS Breath Sounds - DRAFT PH Road Safety Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **RS Breath Sounds**

## ValueSet: RS Breath Sounds 

| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/ValueSet/PH-RoadSafety-BreathSounds | *Version*:0.1.0 |
| Draft as of 2025-10-09 | *Computable Name*:RSBreathSoundsVS |

 
Breath sounds by auscultation (SNOMED CT). 
...
```json
{
  ...
  "id" : "RS-BreathSounds-VS",
  "url" : "http://hl7.org/fhir/ValueSet/PH-RoadSafety-BreathSounds",
  "version" : "0.1.0",
  "name" : "RSBreathSoundsVS",
  "title" : "RS Breath Sounds",
  "status" : "draft",
