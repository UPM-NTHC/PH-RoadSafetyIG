# Road Safety Observation - Pulse Quality - DRAFT PH Road Safety Implementation Guide v0.1.9
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-pulse-quality | *Version*:0.1.9 |
| Draft as of 2025-10-25 | *Computable Name*:RSObsPulseQuality |
...
Other representations of profile: [CSV](StructureDefinition-rs-observation-pulse-quality.csv), [Excel](StructureDefinition-rs-observation-pulse-quality.xlsx), [Schematron](StructureDefinition-rs-observation-pulse-quality.sch) 
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "patternCode" : "78564009"
      },
      {
        "id" : "Observation.code.coding.display",
        "path" : "Observation.code.coding.display",
        "patternString" : "Heart rate measured at systemic artery (observable entity)"
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/ValueSet/vs-pulse-quality"
        }
      }
    ]
  }
