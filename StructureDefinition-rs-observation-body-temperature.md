...
| Draft as of 2025-10-31 | *Computable Name*:RSObsBodyTemperature |
...
* Examples for this Profile: [Observation/rs-bundle-example-observation-body-temperature](Observation-rs-bundle-example-observation-body-temperature.md) and [Observation/rs-example-observation-body-temperature](Observation-rs-example-observation-body-temperature.md)
