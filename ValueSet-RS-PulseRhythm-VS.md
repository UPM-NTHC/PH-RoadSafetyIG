# RS Pulse Rhythm - DRAFT PH Road Safety Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **RS Pulse Rhythm**

## ValueSet: RS Pulse Rhythm 

| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/ValueSet/PH-RoadSafety-PulseRhythm | *Version*:0.1.0 |
| Draft as of 2025-10-09 | *Computable Name*:RSPulseRhythmVS |

 
Pulse rhythm (regular/irregular) using SNOMED CT. 
