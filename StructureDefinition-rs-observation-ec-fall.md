# RS Observation - External Cause: Fall - DRAFT PH Road Safety Implementation Guide v0.3.0
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-ec-fall | *Version*:0.3.0 |
| Draft as of 2025-11-13 | *Computable Name*:RSObsECFall |
...
* Examples for this Profile: [Observation/rs-example-observation-ec-fall](Observation-rs-example-observation-ec-fall.md)
