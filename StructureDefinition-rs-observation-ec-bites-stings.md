# RS Observation - External Cause: Bites/Stings - DRAFT PH Road Safety Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-ec-bites-stings | *Version*:0.2.0 |
| Draft as of 2025-11-03 | *Computable Name*:RSObsECBitesStings |
...
* Examples for this Profile: [Observation/rs-example-observation-ec-bites](Observation-rs-example-observation-ec-bites.md)
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "Specify animal/insect agent (text)",
        "mustSupport" : true
      }
    ]
  }
