# RS Condition — External Cause (category) - DRAFT PH Road Safety Implementation Guide v0.3.0
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-condition-external-cause | *Version*:0.3.0 |
| Draft as of 2025-11-09 | *Computable Name*:RSConditionExternalCause |
...
* Examples for this Profile: [Condition/rs-minimum-example-condition-external-cause](Condition-rs-minimum-example-condition-external-cause.md)
