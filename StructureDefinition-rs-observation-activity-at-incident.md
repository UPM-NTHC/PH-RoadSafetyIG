# Road Safety Observation - Activity at Time of Incident - DRAFT PH Road Safety Implementation Guide v0.1.9
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-activity-at-incident | *Version*:0.1.9 |
| Draft as of 2025-10-25 | *Computable Name*:RSObsActivityAtIncident |
...
Other representations of profile: [CSV](StructureDefinition-rs-observation-activity-at-incident.csv), [Excel](StructureDefinition-rs-observation-activity-at-incident.xlsx), [Schematron](StructureDefinition-rs-observation-activity-at-incident.sch) 
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "patternString" : "Injury associated activity"
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/ValueSet/vs-activity"
        }
      },
      {
