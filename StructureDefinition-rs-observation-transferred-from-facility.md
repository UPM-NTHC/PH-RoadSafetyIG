# Road Safety Observation - Transferred From Facility - DRAFT PH Road Safety Implementation Guide v0.1.9
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-transferred-from-facility | *Version*:0.1.9 |
| Draft as of 2025-10-25 | *Computable Name*:RSObsTransferredFromFacility |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "patternString" : "Transferred from another acute care facility [NTDS]"
      },
      {
