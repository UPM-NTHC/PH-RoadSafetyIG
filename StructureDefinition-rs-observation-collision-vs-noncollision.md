# RS Observation - Collision vs Non-Collision - DRAFT PH Road Safety Implementation Guide v0.3.0
...
| Draft as of 2025-11-05 | *Computable Name*:RSObsCollisionVsNonCollision |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-TransportAccidentCollision"
        }
      }
    ]
  }
