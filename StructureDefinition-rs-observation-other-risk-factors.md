# RS Observation - Other Risk Factors - DRAFT PH Road Safety Implementation Guide v0.3.0
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-other-risk-factors | *Version*:0.3.0 |
| Draft as of 2025-11-14 | *Computable Name*:RSObsOtherRiskFactors |
...
* Examples for this Profile: [Observation/RSMinimumExampleObsOtherRiskFactors](Observation-RSMinimumExampleObsOtherRiskFactors.md) and [Observation/rs-example-observation-risk-factors](Observation-rs-example-observation-risk-factors.md)
...
Other representations of profile: [CSV](StructureDefinition-rs-observation-other-risk-factors.csv), [Excel](StructureDefinition-rs-observation-other-risk-factors.xlsx), [Schematron](StructureDefinition-rs-observation-other-risk-factors.sch) 
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-RiskFactors"
        }
      },
      {
