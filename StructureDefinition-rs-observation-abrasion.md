# RS Observation - Abrasion - DRAFT PH Road Safety Implementation Guide v0.3.0
...
| Draft as of 2025-11-16 | *Computable Name*:RSObsAbrasion |
...
* Examples for this Profile: [Observation/RSMinimumExampleObsAbrasion](Observation-RSMinimumExampleObsAbrasion.md) and [Observation/rs-example-observation-abrasion](Observation-rs-example-observation-abrasion.md)
...
Other representations of profile: [CSV](StructureDefinition-rs-observation-abrasion.csv), [Excel](StructureDefinition-rs-observation-abrasion.xlsx), [Schematron](StructureDefinition-rs-observation-abrasion.sch) 
