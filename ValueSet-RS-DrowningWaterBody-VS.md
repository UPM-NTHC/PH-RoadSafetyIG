# RS Drowning Body of Water - DRAFT PH Road Safety Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **RS Drowning Body of Water**

## ValueSet: RS Drowning Body of Water 

| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/ValueSet/PH-RoadSafety-DrowningWaterBody | *Version*:0.1.0 |
| Draft as of 2025-10-09 | *Computable Name*:RSDrowningWaterBodyVS |

 
Type/body of water involved in drowning (SNOMED). 
