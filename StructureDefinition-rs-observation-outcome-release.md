# RS Observation - Outcome at Release - DRAFT PH Road Safety Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-outcome-release | *Version*:0.2.0 |
| Draft as of 2025-11-01 | *Computable Name*:RSObsOutcome |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-Outcome"
        }
      }
    ]
  }
