# RS Observation - Time On Scene - DRAFT PH Road Safety Implementation Guide v0.1.9

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **RS Observation - Time On Scene**

## Resource Profile: RS Observation - Time On Scene 

| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-time-on-scene | *Version*:0.1.9 |
| Draft as of 2025-10-27 | *Computable Name*:RSObsTimeOnScene |
...
```json
{
  ...
  "title" : "RS Observation - Time On Scene",
  "status" : "draft",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "patternCode" : "405798008"
      },
      {
        "id" : "Observation.code.coding.display",
        "path" : "Observation.code.coding.display",
        "patternString" : "Time of arrival of emergency services (observable entity)"
      },
      {
