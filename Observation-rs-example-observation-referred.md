# Example RS Observation - Referred By Facility - DRAFT PH Road Safety Implementation Guide v0.3.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example RS Observation - Referred By Facility**

## Example Observation: Example RS Observation - Referred By Facility

Profile: [RS Observation - Referred By Facility](StructureDefinition-rs-observation-referred-by-facility.md)

**status**: Final

**code**: Referral by establishment (procedure)
...
**effective**: 2025-10-31 16:32:00+0800
