# RS Observation - Presence of Traffic Investigator - DRAFT PH Road Safety Implementation Guide v0.1.9

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **RS Observation - Presence of Traffic Investigator**

## Resource Profile: RS Observation - Presence of Traffic Investigator 

| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-traffic-investigator | *Version*:0.1.9 |
| Draft as of 2025-10-27 | *Computable Name*:RSObsPresenceTrafficInvestigator |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "patternCode" : "159679004"
      },
      {
        "id" : "Observation.code.coding.display",
        "path" : "Observation.code.coding.display",
        "patternString" : "Traffic warden (occupation)"
      },
      {
