# RS Observation - Avulsion - DRAFT PH Road Safety Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-avulsion | *Version*:0.2.0 |
| Draft as of 2025-11-03 | *Computable Name*:RSObsAvulsion |
...
* Examples for this Profile: [Observation/rs-example-observation-avulsion](Observation-rs-example-observation-avulsion.md)
