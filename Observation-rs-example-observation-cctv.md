# Example RS Observation - CCTV Available - DRAFT PH Road Safety Implementation Guide v0.3.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example RS Observation - CCTV Available**

## Example Observation: Example RS Observation - CCTV Available

Profile: [RS Observation - CCTV Available](StructureDefinition-rs-observation-cctv-available.md)

**status**: Final

**code**: Closed circuit television (physical object)
...
**effective**: 2025-10-31 17:54:00+0800
...
```json
{
  ...
  "id" : "rs-example-observation-cctv",
  "meta" : {
    "profile" : [
