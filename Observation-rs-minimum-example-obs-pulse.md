# Minimum Data Set Pulse - DRAFT PH Road Safety Implementation Guide v0.3.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Minimum Data Set Pulse**

## Example Observation: Minimum Data Set Pulse
...
**value**: 88 /min(Details: UCUM code/min = '/min')
