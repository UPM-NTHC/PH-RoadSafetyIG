# RS Observation - Mode of Transport to Facility - DRAFT PH Road Safety Implementation Guide v0.3.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **RS Observation - Mode of Transport to Facility**

## Resource Profile: RS Observation - Mode of Transport to Facility 
...
| Draft as of 2025-11-09 | *Computable Name*:RSObsModeOfTransport |
...
* Examples for this Profile: [Observation/rs-example-observation-mode-transport](Observation-rs-example-observation-mode-transport.md), [Observation/rs-minimum-example-obs-mode-transport-other](Observation-rs-minimum-example-obs-mode-transport-other.md) and [Observation/rs-minimum-example-observation-mode-transport](Observation-rs-minimum-example-observation-mode-transport.md)
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "http://www.roadsafetyph.doh.gov.ph/ValueSet/SILPH-ModeofTransport"
        }
      },
      {
