# Example RS Observation - Priority Level - DRAFT PH Road Safety Implementation Guide v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example RS Observation - Priority Level**

## Example Observation: Example RS Observation - Priority Level

Profile: [RS Observation - Priority Level (Urgency)](StructureDefinition-rs-observation-urgency.md)

**status**: Final

**code**: Priority (attribute)
...
**effective**: 2025-10-31 17:02:00+0800
