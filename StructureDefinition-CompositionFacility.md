...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/CompositionFacility | *Version*:0.1.0 |
| Draft as of 2025-10-09 | *Computable Name*:CompositionFacility |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/example.fhir.ph.roadsafety|current/StructureDefinition/CompositionFacility)
...
```json
{
  ...
  "url" : "https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/CompositionFacility",
  "version" : "0.1.0",
  "name" : "CompositionFacility",
    ...
    "element" : [
      ...
      },
      {
        ...
        "patternCodeableConcept" : {
          "coding" : [
            {
              "system" : "https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/CodeSystem/RSCompositionTypeCS-Facility",
      ...
      },
      {
        ...
        "patternCodeableConcept" : {
          "coding" : [
            {
              "system" : "https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/CodeSystem/RSFacilitySectionCS",
              "code" : "patient",
              "display" : "Patient"
            }
          ]
      ...
      {
        "id" : "Composition.section:edVitals",
        "path" : "Composition.section",
        "sliceName" : "edVitals",
        "min" : 0,
        "max" : "*"
      ...
      {
        "id" : "Composition.section:edVitals.title",
        "path" : "Composition.section.title",
        "patternString" : "ED Vitals"
      },
      {
        "id" : "Composition.section:edVitals.code",
        "path" : "Composition.section.code",
        "min" : 1,
        "patternCodeableConcept" : {
          "coding" : [
      ...
      {
        "id" : "Composition.section:edVitals.entry",
        "path" : "Composition.section.entry",
        "type" : [
          {
            "code" : "Reference",
      ...
      {
        "id" : "Composition.section:conditions",
        "path" : "Composition.section",
      ...
      {
        "id" : "Composition.section:conditions.title",
        "path" : "Composition.section.title",
        "patternString" : "Conditions"
      },
      {
        "id" : "Composition.section:conditions.code",
        "path" : "Composition.section.code",
        "min" : 1,
        "patternCodeableConcept" : {
          "coding" : [
      ...
      {
        "id" : "Composition.section:conditions.entry",
        "path" : "Composition.section.entry",
        "type" : [
          {
            "code" : "Reference",
      ...
      {
        "id" : "Composition.section:outcome.title",
        "path" : "Composition.section.title",
        "patternString" : "Outcome"
      },
      {
      ...
      {
        "id" : "Composition.section:outcome.entry",
        "path" : "Composition.section.entry",
        "type" : [
          {
            "code" : "Reference",
      ...
      {
        "id" : "Composition.section:transport.entry",
        "path" : "Composition.section.entry",
        "type" : [
          {
            "code" : "Reference",
            "targetProfile" : [
              "https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/ObservationModeOfTransport"
            ]
          }
        ]
      },
