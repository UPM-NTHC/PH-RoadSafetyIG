# Road Safety Observation - Pulse Rhythm - DRAFT PH Road Safety Implementation Guide v0.1.9
...
| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-pulse-rhythm | *Version*:0.1.9 |
| Draft as of 2025-10-25 | *Computable Name*:RSObsPulseRhythm |
...
Other representations of profile: [CSV](StructureDefinition-rs-observation-pulse-rhythm.csv), [Excel](StructureDefinition-rs-observation-pulse-rhythm.xlsx), [Schematron](StructureDefinition-rs-observation-pulse-rhythm.sch) 
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "patternCode" : "364095004"
      },
      {
        "id" : "Observation.code.coding.display",
        "path" : "Observation.code.coding.display",
        "patternString" : "Pulse rhythm (observable entity)"
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/ValueSet/vs-pulse-rhythm"
        }
      }
    ]
  }
