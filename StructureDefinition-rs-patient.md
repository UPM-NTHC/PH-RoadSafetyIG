...
| Draft as of 2025-11-13 | *Computable Name*:RSPatient |
...
* Examples for this Profile: [Patient/RSMinimumExamplePatient](Patient-RSMinimumExamplePatient.md) and [Patient/rs-example-patient](Patient-rs-example-patient.md)
