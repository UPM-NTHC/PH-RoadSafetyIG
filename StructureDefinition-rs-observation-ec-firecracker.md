# RS Observation - External Cause: Firecracker - DRAFT PH Road Safety Implementation Guide v0.3.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **RS Observation - External Cause: Firecracker**

## Resource Profile: RS Observation - External Cause: Firecracker 

| | |
| :--- | :--- |
| *Official URL*:https://build.fhir.org/ig/UPM-NTHC/PH-RoadSafetyIG/StructureDefinition/rs-observation-ec-firecracker | *Version*:0.3.0 |
| Draft as of 2025-11-09 | *Computable Name*:RSObsECFirecracker |
...
* Examples for this Profile: [Observation/rs-example-observation-ec-firecracker](Observation-rs-example-observation-ec-firecracker.md)
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "Specify firecracker types",
        "min" : 0,
        "max" : "1",
        "type" : [
          {
